...
class ImageStickerContainerView: UIView, ZLImageStickerContainerDelegate {
    ...
    override func layoutSubviews() {
        ...
        let path = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: self.frame.width, height: self.frame.height), byRoundingCorners: [.topLeft, .topRight], cornerRadii: CGSize(width: 8, height: 8))
    ...
    func setupUI() {
        ...
        self.baseView.snp.makeConstraints { (make) in
            make.right.equalTo(self.snp.right).offset(500)
